...
def resumo(num,taxaA=10,taxaD=15):
    print(30* '-')
    print('RESUMO DO VALOR'.center(30))
    print(30 * '-')
    print(f'VALOR ANALISADO: \t{moeda(num)}')
    print(f'DOBRO DO VALOR:   \t{moeda(dobro(num))}')
    print(f'METADE DO VALOR:   \t{metade(num,True)}')
    print(f'AUMENTO DE {taxaA}%  \t{aumentar(num,taxaA,True)}')
    print(f'DIMINUIÇÃO DE {taxaD}% \t{diminuir(num,taxaD,True)}')
    print(30 * '-')
